 ...
 <>
    <div>
      <form
        ...
        className="bg-white rounded-2xl shadow-2xl p-8 w-[400px] mx-auto"
      >
        <div className="text-center mb-8">
          <div className="inline-flex items-center gap-2 text-[#6cd9b1] font-bold text-2xl">
            <div className="w-6 h-6 bg-[#75d6b3] rounded-full flex items-center justify-center">
          ...
          <button
            ...
            className={`w-full py-3 rounded-lg font-semibold transition-all duration-300 mt-6 flex items-center justify-center gap-2 ${
              isLoading
                ...
                : "bg-[#71dab4] hover:bg-[#5cc9a3] cursor-pointer"
            } text-white`}
          >
            {isLoading ? (
              <>
