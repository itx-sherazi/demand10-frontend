...
const FocusLines = ({ focus, onFocusChange }) => {
  ...
  <div className="space-y-4">
    <h3 className="text-lg font-bold text-[#1a365d]">Focus Areas</h3>
  ...
  <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div className="p-4 border-t border-gray-200">
              <div className="space-y-3">
                {category.options.map((option) => {
                  ...
                  return (
                    <div key={focusId} className="flex items-center gap-3">
                      <input
                        type="checkbox"
                        id={focusId}
                        checked={isSelected}
    ...
    <div className="bg-blue-50 border border-blue-200 rounded-xl p-5 shadow-sm">
      <h4 className="font-bold text-[#1a365d] mb-4">Focus Distribution</h4>
            ...
            <div className="space-y-3">
              ...
              {focus.map((focusItem, index) => (
                <div key={index} className="flex justify-between text-sm py-1">
                  <span className="text-[#1a365d]">{focusItem.focusName}</span>
