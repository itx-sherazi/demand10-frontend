...
export default function OtherSections() {
  ...
  return (
    <div>
      {/* Why Us Section */}
      <div className="bg-gradient-to-r from-[#314158] to-[#253347] rounded-2xl p-6 md:p-8 text-white mx-4 my-8 shadow-xl">
        ...
        <div className="text-center">
          <button 
            ...
            className="bg-gradient-to-r from-orange-500 to-orange-600 hover:from-orange-600 hover:to-orange-700 text-white font-bold py-3 px-8 rounded-lg transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl"
          >
            ...
            {serviceType === 'custom' ? (
              <>
                ...
                <div className="bg-white rounded-xl shadow-lg p-6 text-center border border-gray-100 hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
                  <div className="w-16 h-16 bg-gradient-to-br from-[#314158]/10 to-[#253347]/10 rounded-full shadow-md flex items-center justify-center mx-auto mb-4 border border-[#314158]/20">
                    <img 
                  ...
                  <button 
                    ...
                    className="bg-gradient-to-r from-[#314158] to-[#253347] hover:from-[#253347] hover:to-[#1a2533] text-white font-medium py-2.5 px-5 rounded-lg transition-all duration-300 shadow-md hover:shadow-lg"
                  >
                    Get a Free Estimate
                  </button>
                </div>
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="flex flex-wrap justify-center gap-8 my-12">
            <div className="text-center">
              <div className="w-24 h-24 bg-white rounded-full flex items-center justify-center mx-auto mb-4 border border-gray-100 shadow-md relative hover:shadow-lg transition-all duration-300">
                <div className="absolute -top-2 -left-2 w-8 h-8 bg-gradient-to-br from-[#314158] to-[#253347] rounded-full flex items-center justify-center text-white font-bold text-sm shadow-md">
                  1
                </div>
                <img 
          ...
          <div className="text-center mt-10">
            <button 
              ...
              className="bg-gradient-to-r from-[#314158] to-[#253347] hover:from-[#253347] hover:to-[#1a2533] text-white font-bold py-3 px-8 rounded-lg transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl"
            >
          ...
          {[...Array(6)].map((_, index) => (
            ...
            >
              <div className="bg-gradient-to-br from-gray-100 to-gray-200 border border-gray-200 rounded-lg w-16 h-16 flex items-center justify-center">
                <span className="text-[#314158] font-bold text-xs">Logo {index + 1}</span>
              </div>
            </div>
          ))}
        </div>
