  ...
  return (
    <div className="bg-gradient-to-br from-[#f8f9fa] to-[#e9ecef] rounded-3xl shadow-xl p-8 md:p-12 border border-gray-200 relative overflow-hidden">
      ...
      <div className="relative z-10">
        ...
        <p className="text-center text-[#253347] mb-12 max-w-2xl mx-auto text-lg">
          Writing a review is simple and straightforward. Follow these easy steps to share your experience.
        </p>
        
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="bg-white rounded-2xl p-8 text-center border border-[#314158]/20 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2">
            <div className="w-20 h-20 bg-gradient-to-br from-[#314158] to-[#253347] rounded-2xl flex items-center justify-center mx-auto mb-6 shadow-lg">
              <FaSearch className="text-white text-3xl" />
            </div>
            <h3 className="text-2xl font-bold text-[#314158] mb-4">Search Company</h3>
            <p className="text-[#253347] mb-4">
          ...
          <div className="bg-white rounded-2xl p-8 text-center border border-[#314158]/20 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2">
            ...
            <h3 className="text-2xl font-bold text-[#314158] mb-4">Sign In</h3>
            <p className="text-[#253347] mb-4">
          ...
          <div className="bg-white rounded-2xl p-8 text-center border border-[#314158]/20 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2">
            ...
            <h3 className="text-2xl font-bold text-[#314158] mb-4">Write Review</h3>
            <p className="text-[#253347] mb-4">
